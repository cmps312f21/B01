...
fun main() {
    ...
    val audioBook1 = AudioBook("Loard of the rings V1 ", "J.R.R", 1954, 12, 300, " Elshahawy")
    val audioBook2 = AudioBook("Loard of the rings V2 ", "J.R.R", 1955, 12, 100, "Yousseif ")
    val audioBook3 = AudioBook("Loard of the rings V3", "J.R.R", 1956, 12, 200, "Ali")
    ...
    val books = mutableListOf<Book>(paperBook1, audioBook1, audioBook2 , paperBook2 , audioBook3 , paperBook3)

    //question , po
    for (book in books){
        if(book is AudioBook) //smart casting
            if(book.length > 300) println("Long book")
    }
